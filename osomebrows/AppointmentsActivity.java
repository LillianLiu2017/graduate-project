...
public class AppointmentsActivity extends AppCompatActivity {
    ...
    public void fiilSpinners() {
        ...
        String[] times = new String[]{"09:00", "10:00", "11:00", "12:00", "13:00", "14:00", "15:00", "16:00"};
        ...
        String[] staff = new String[]{"staff1", "staff2", "staff3"};
        ...
        String[] services = new String[]{"Hair cut $50", "Eyelash Extensions $99", "Waxing $99"};
        ...
        String[] location = new String[]{"Southland","Doncaster","Glen Waverly"};
        ArrayAdapter<String> adapterLocation = new ArrayAdapter<String>(this,android.R.layout.simple_spinner_dropdown_item,location);
    ...
    public void btnSubmitAppointmentClicked(View view) {
        try {
            ...
            DBBookings appointment = new DBBookings(userName, spnStaff.getSelectedItem().toString(),
                    spnService.getSelectedItem().toString(), txtDateAppoint.getText().toString(), spnTime.getSelectedItem().toString());

            String selectService = spnService.getSelectedItem().toString();
            if(selectService.equals("Hair cut $50")){
                servicePrice = "50";
            }else if(selectService.equals("Eyelash Extensions $99")){
                servicePrice = "99";
            }else{
                servicePrice = "99";
            }
            ...
            Intent mainIntent = new Intent(this,PayBooking.class);
            startActivity(mainIntent);
        } catch (Exception e) {
